...
public class SyncProxy {
	 ...
	 */
	@Deprecated
	public static <ServiceIntf> ServiceIntf newProxyInstance(Class<ServiceIntf> serviceIntf, String moduleBaseURL) {
	...
	public static <ServiceIntf> ServiceIntf newProxyInstance(Class<ServiceIntf> serviceIntf, String moduleBaseURL,
		...
		RemoteServiceRelativePath relativePathAnn = serviceIntf.getAnnotation(RemoteServiceRelativePath.class);
	...
	public static <ServiceIntf> ServiceIntf newProxyInstance(Class<ServiceIntf> serviceIntf, String moduleBaseURL,
		...
		return newProxyInstance(serviceIntf, moduleBaseURL, remoteServiceRelativePath,
				POLICY_MAP.get(serviceIntf.getName()), DEFAULT_COOKIE_MANAGER, waitForInvocation);
	}
	...
	public static <ServiceIntf> ServiceIntf newProxyInstance(Class<ServiceIntf> serviceIntf, String moduleBaseURL,
		...
		return newProxyInstance(serviceIntf, moduleBaseURL, remoteServiceRelativePath, policyName,
	...
	@Deprecated
	public static <ServiceIntf> ServiceIntf newProxyInstance(Class<ServiceIntf> serviceIntf, String moduleBaseURL,
			String remoteServiceRelativePath, String policyName, CookieManager cookieManager) {
	...
	@Deprecated
	public static <ServiceIntf> ServiceIntf newProxyInstance(Class<ServiceIntf> serviceIntf, String moduleBaseURL,
			String remoteServiceRelativePath, String policyName, CookieManager cookieManager, boolean waitForInvocation) {
		return newProxyInstance(serviceIntf, moduleBaseURL, moduleBaseURL, remoteServiceRelativePath, policyName,
	...
	@SuppressWarnings("unchecked")
	public static <ServiceIntf> ServiceIntf newProxyInstance(Class<ServiceIntf> serviceIntf, String moduleBaseURL,
			String serverBaseUrl, String remoteServiceRelativePath, String policyName, CookieManager cookieManager,
			boolean waitForInvocation) {
