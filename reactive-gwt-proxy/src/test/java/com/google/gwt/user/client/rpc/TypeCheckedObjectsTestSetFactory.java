 ...
 * {@link TypeCheckedObjectsTest} unit tests.
 */
public class TypeCheckedObjectsTestSetFactory {
    ...
    public static TypeCheckedGenericClass<Integer, HashSet<String>> createInvalidCheckedGenericClass() {
    ...
    public static TypeUncheckedGenericClass<Integer, HashSet<String>> createInvalidUncheckedGenericClass() {
