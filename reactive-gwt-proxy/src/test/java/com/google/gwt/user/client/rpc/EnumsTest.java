...
//				 * since it will force an implicit upcast on FieldEnum ->
//				 * Object, which will bias the test. We want to assert that the
//				 * EnumOrdinalizer properly prevents ordinalization of
//				 * FieldEnum.
//				 */
