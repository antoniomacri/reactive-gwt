 ...
 */
@RemoteServiceRelativePath("typecheckedobjects")
public interface TypeCheckedObjectsTestServiceAsync {
    /**
     * @see TypeCheckedObjectsTestService#echo(com.google.gwt.user.client.rpc.TypeCheckedObjectsTestSetFactory.TypeCheckedFieldClass)
     */
    ...
    /**
     * @see TypeCheckedObjectsTestService#echo(com.google.gwt.user.client.rpc.TypeCheckedObjectsTestSetFactory.TypeCheckedNestedLists)
     */
    void echo(TypeCheckedNestedLists arg1, AsyncCallback<TypeCheckedNestedLists> callback);

    /**
     * @see TypeCheckedObjectsTestService#echo(com.google.gwt.user.client.rpc.TypeCheckedGenericClass)
     */
    @SuppressWarnings("rawtypes")
    ...
    /**
     * @see TypeCheckedObjectsTestService#echo(com.google.gwt.user.client.rpc.TypeCheckedObjectsTestSetFactory.TypeCheckedSuperClass)
     */
    @SuppressWarnings("rawtypes")
    ...
    /**
     * @see TypeCheckedObjectsTestService#echo(com.google.gwt.user.client.rpc.TypeUncheckedGenericClass)
     */
    @SuppressWarnings("rawtypes")
